...
def eular_to_msg(x, y, z, rx, ry, rz, inverse=False):
    ...
    if not inverse:
        ...
        return {"position": {"x": x, "y": y, "z": z},
                "orientation": {"w": rot[0], "x": rot[1], "y": rot[2], "z": rot[3]}}
    else:
        ...
        return {"position": {"x": mat[0][3], "y": mat[1][3], "z": mat[2][3]},
                "orientation": {"w": rot[0], "x": rot[1], "y": rot[2], "z": rot[3]}}
...
if __name__ == '__main__':
    ...
    if len(samples) > 2:
        ...
        for algoram in hand_calib.AVAILABLE_ALGORITHMS:
            ...
            data.append(["end_link->marker:" + algoram, pose[0], pose[1], pose[2], pose[3], pose[4], pose[5], pose[6],
                         hand_calib._distance(pose[0], pose[1], pose[2])])
